...
#+begin_src emacs-lisp :var four=four :results silent
  (length four)
#+end_src
...
#+begin_src emacs-lisp :var numbers='(1 2 3 4 5 6 7) :results silent
...
#+begin_src emacs-lisp :var n=5 :exports both :results silent
...
#+source: take-sqrt
#+begin_src emacs-lisp :var n=9 :results silent
  (sqrt n)
#+end_src
...
#+source: concat
#+begin_src emacs-lisp :var a=0 :var b=0 :var c=0 :results silent
  (format "%S%S%S" a b c)
#+end_src
...
#+source: double
#+begin_src emacs-lisp :var it=0 :results silent
  (* 2 it)
#+end_src
...
#+begin_src emacs-lisp :results wrap :exports both :results silent
    "code block results"
#+end_src
#+begin_src emacs-lisp :var lst=a-list :results list silent
  (reverse lst)
#+end_src
...
#+begin_src emacs-lisp :var text=d4faa7b3-072b-4dcf-813c-dd7141c633f3 :results silent
  (length text)
#+end_src
...
#+begin_src sh :results scalar silent
  echo "[[file:./cv.cls]]"
#+end_src

#+begin_src sh :results raw scalar silent
   echo "[[file:./cv.cls]]"
#+end_src
